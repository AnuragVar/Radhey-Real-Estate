function About() {
  return (
    <div className="text-slate-500 max-w-6xl mx-auto pt-20 flex flex-col gap-4">
      ...
      <div>
        ...
        <p>
          At Radhey Real Estate, our mission is to connect people with their
          dream homes and investment opportunities. Whether you are looking to
          buy, sell, or rent, we provide personalized solutions tailored to your
      ...
      <div>
        ...
        <ul className="flex flex-col gap-1">
          <li>
            ...
            : Explore a wide range of properties for sale, from cozy starter
            homes to luxurious estates. Our expert agents are here to guide you
          ...
          <li>
            ...
            : Find your perfect rental home with ease. We offer a diverse
            selection of rental properties that cater to various lifestyles and
            budgets.
          </li>
          <li>
            <span className="text-md text-slate-700 font-semibold underline">
            ...
            : Our team of experienced real estate professionals brings a wealth
            of knowledge and insight to help you make informed decisions. We are
      ...
      <div>
        ...
        <ul className="flex flex-col gap-1">
          ...
          <li>
            ...
            significant milestone. Let us be your trusted partner in this
            exciting journey, and together, we'll unlock the doors to your
            dreams.
          </li>
        </ul>
      </div>
